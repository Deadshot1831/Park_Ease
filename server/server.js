...
// Strip $ / . from keys in body, query, params → blocks NoSQL operator injection
...
// --- Global rate limiter ---
app.use('/api', createRateLimiter({ windowMs: 60 * 1000, max: Number(process.env.RATE_LIMIT_MAX) || 200 }));
